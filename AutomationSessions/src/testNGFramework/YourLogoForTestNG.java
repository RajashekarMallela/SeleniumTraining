...
public class YourLogoForTestNG {
	WebDriver driver;
		...
		//Registration
		@Test(priority=2)
		public void intialRegistration() throws InterruptedException {
		driver.findElement(By.xpath("//a[@class='login']")).click();
		driver.findElement(By.id("email_create")).sendKeys("Jan090067203091@gmail.com");
		Thread.sleep(2000);
		...
		@Test(priority=6)
		public void signIn() {
		driver.findElement(By.id("email")).sendKeys("Jan090067203091@gmail.com");
		driver.findElement(By.id("passwd")).sendKeys("Passw0rd$123");
