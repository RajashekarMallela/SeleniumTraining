...
public class YourLogoForTestNGAnnotations {
	WebDriver driver;
		...
		driver.findElement(By.id("email_create")).sendKeys("FJan090067203091@gmail.com");
		Thread.sleep(2000);
		...
		driver.findElement(By.id("email")).sendKeys("FJan090067203091@gmail.com");
		driver.findElement(By.id("passwd")).sendKeys("Passw0rd$123");
		driver.findElement(By.id("SubmitLogin")).click();
		}
		@AfterTest
		public void g_browserrclosure() {
			driver.close();
		}
	}
